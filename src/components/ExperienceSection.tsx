    ...
    <section id="experience" className="pt-14">
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-2 gap-4 xl:gap-6 2xl:gap-8">
        ...
        <div className="card-portfolio">
          ...
          <div className="relative pl-5 mt-2">
            ...
            <div className="relative mb-5 pl-3">
              ...
              <div className="text-xs text-foreground/80 mb-1">Company Name · MM YYYY – MM YYYY · Location</div>
              <div className="text-xs text-foreground/95">
            ...
            <div className="relative mb-5 pl-3">
              ...
              <div className="text-xs text-foreground/80 mb-1">Ongoing</div>
              <div className="text-xs text-foreground/95">
            ...
            <div className="relative pl-3">
              ...
              <div className="text-xs text-foreground/80 mb-1">Actively looking · Remote / On‑site</div>
              <div className="text-xs text-foreground/95">
        ...
        <div className="card-portfolio">
          ...
          <p className="text-sm text-foreground/95 mb-3">
          ...
          <ul className="pl-4 list-disc text-sm text-foreground/95 space-y-1 mb-4">
