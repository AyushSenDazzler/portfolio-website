  ...
  return (
    <section id="contact" className="pt-14">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        {/* Contact Form */}
        <form onSubmit={handleSubmit} className="card-portfolio">
          ...
          <div className="mb-3">
            ...
            <input
              ...
              required
              className="w-full rounded-lg px-3 py-2 border border-border/60 bg-card/98 text-foreground text-sm outline-none focus:border-primary/80 focus:ring-1 focus:ring-primary/50 transition-all placeholder:text-muted-foreground/50"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              rows={4}
              className="w-full rounded-lg px-3 py-2 border border-border/60 bg-card/98 text-foreground text-sm outline-none focus:border-primary/80 focus:ring-1 focus:ring-primary/50 transition-all resize-y placeholder:text-muted-foreground/50"
            />
          </div>
